 ...
 */
// #define EXTRUDER_RUNOUT_PREVENT // Ricardo
...
#define NOZZLE_PARK_POINT {110, 180, 20} // X = centro da cama, Y = frente, Z = sobe 10mm
#define NOZZLE_PARK_XY_FEEDRATE 100      // Velocidade XY do movimento de parque
#define NOZZLE_PARK_Z_FEEDRATE 5         // Velocidade da subida do bico
#define NOZZLE_PARK_XY_FEEDRATE_FAST 200 // Velocidade rápida (se usada)
...
#define X_HOLD_MULTIPLIER 0.7 // Enable to override 'HOLD_MULTIPLIER' for the X axis
#endif
 ...
 */
#define MONITOR_DRIVER_STATUS // Ricardo
 ...
 */
// #define HYBRID_THRESHOLD // Ricardo
